...
def main(args):
    ...
    dataset_train = FTSR512Dataset(dataset_folder=args.train_folders[0], min_no=200, max_no=100199)
    ...
    dataset_val = FTSR512Dataset(dataset_folder=args.train_folders[0], min_no=0, max_no=10)
