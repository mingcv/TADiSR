...
from .utils import compute_token_merge_indices, cached_nlp, auto_autocast, compute_token_merge_indices_kolors
...
class GlobalHeatMap:
    ...
    def compute_word_heat_map_kolors(self, word: str, word_idx: int = None, offset_idx: int = 0) -> WordHeatMap:
        merge_idxs, word_idx = compute_token_merge_indices_kolors(
